...
var uploadedDocs = ref(__spreadArray([], props.deed.deedDocs || [], true));
watch(function () { return props.deed; }, function (newDeed) {
...
var requiredDocs = computed(function () {
    if (!props.deed || !props.deed.deedType)
        return [];
    var allRequired = requiredDocumentsMap[props.deed.deedType] || [];
...
if (__VLS_ctx.show && __VLS_ctx.deed) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "fixed inset-0 z-50 bg-black bg-opacity-40 flex items-center justify-center" }));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "bg-white rounded shadow-lg w-full max-w-lg p-6 relative" }));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.h3, __VLS_intrinsicElements.h3)(__assign({ class: "text-xl font-bold mb-4" }));
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)(__assign({ onClick: (__VLS_ctx.onClose) }, { class: "absolute top-2 right-2 text-gray-500 hover:text-gray-700" }));
}
