...
onMounted(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, api.get('/clients', {
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "flex justify-between  mb-4 w-10/12" }));
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: " bg-white p-6 rounded-md shadow-md overflow-x-auto" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.table, __VLS_intrinsicElements.table)(__assign({ class: "w-full table-auto border border-gray-300 mt-5" }));
...
for (var _i = 0, _a = __VLS_getVForSourceType((__VLS_ctx.clients)); _i < _a.length; _i++) {
    var _b = _a[_i], c = _b[0], index = _b[1];
    __VLS_asFunctionalElement(__VLS_intrinsicElements.tr, __VLS_intrinsicElements.tr)({
        key: (c.id),
    });
    ...
    // @ts-ignore
    var __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0(__assign({ to: ("/clients/".concat(c.id, "/show")) }, { class: "text-blue-500 hover:underline" })));
    var __VLS_2 = __VLS_1.apply(void 0, __spreadArray([__assign({ to: ("/clients/".concat(c.id, "/show")) }, { class: "text-blue-500 hover:underline" })], __VLS_functionalComponentArgsRest(__VLS_1), false));
    __VLS_3.slots.default;
    var __VLS_3;
}
if (__VLS_ctx.clients.length === 0) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.tr, __VLS_intrinsicElements.tr)({});
